...
export const LogoIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
    ...
    <path d="M13 11h-2v4H9v-4H7V9h6v2zm4-1.41L15.59 11 17 12.41 18.41 11 17 9.59zM12.5 7.5h-1v-1h1v1z" />
    <path d="M16.5 14.5l-1.5 1.5-1.5-1.5 1.5-1.5 1.5 1.5zM11 16.5H9v2h2v-2z" />
  </svg>
);
